# Hancock County MS — Claude Code Context

## Project Overview
Business directory website for Hancock County, Mississippi (hancockcountyms.com).
Lists local businesses, events, deals/coupons across five communities on the Gulf Coast.

## Tech Stack
- **Framework:** Astro (static site generator)
- **Deployment:** Vercel (auto-deploys on git push to GitHub)
- **Email:** Resend API (`RESEND_API_KEY` env var on Vercel)
- **Repo:** github.com/robrecio-create/hancockcountyms
