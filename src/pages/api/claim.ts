...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    if (RESEND_API_KEY) {
      const emailBody = [
        `New CLAIM REQUEST on HancockCountyMS.com`,
        '',
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'HancockCountyMS.com <noreply@contact.hancockcountyms.com>',
          to: ['hello@hancockcountyms.com'],
          subject: `New Claim Request: ${business.title} — HancockCountyMS.com`,
          reply_to: email,
          text: emailBody,
        }),
