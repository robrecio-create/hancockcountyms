...
/**
 * Fetch approved events for Hancock County from the shared Supabase events table.
 * Falls back to the local events.json if Supabase is unavailable.
 */
export async function getCountyEvents(county: string = 'hancock-ms'): Promise<SharedEvent[]> {
